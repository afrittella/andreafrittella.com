  ...
  return (
    <ClientOnly>
      <LazyLoading className={`${isBig ? 'h-[400px]' : 'h-[250px]'}`}>
        ...
        <div
          className={
            'group cursor-pointer group relative bg-black block w-full h-full flex flex-col items-center justify-items-center'
          }
          onClick={handleThumbClick}
        >
          <div
            className='absolute transition-all ease-in-out duration-300 w-full h-full bg-clip-border bg-origin-border bg-center opacity-100 group-hover:opacity-30 bg-no-repeat'
          ...
          <div
            className='absolute top-0 grow-0 w-full wrap-break-word
