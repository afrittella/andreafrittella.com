...
const SocialButton = ({
  ...
  return (
    ...
    <a target="_blank" className='m-auto main-gradient max-w-[430px] min-w-[340px] lg:min-w-[422px] w-full h-[100px] p-[1px] rounded-xl hover:-translate-y-1 transition-all ease-in-out duration-200'>
